...
ba_campaign = Campaign.changeset(%Campaign{}, %{
  ...
  podcast_id: nnpi.id,
  start_date: %{day: 17, month: 1, year: 2018, minute: 0, hour: 0},
  end_date: %{day: 17, month: 2, year: 2018, minute: 0, hour: 0},
  due_date: %{day: 10, month: 1, year: 2018, minute: 0, hour: 0},
...
zip_campaign = Campaign.changeset(%Campaign{}, %{
  ...
  due_date: %{day: 17, month: 4, year: 2010},
